# range_slicer_framebuf 2019-05-09 v01.py
# ItsyBitsy M4 Express version
...
# on-board DotStar indicator (output); set to pale blue for power on
...
if oled_connected:
    ...
    oled.text("  CPy " + os.uname()[3][0:10], 0, 50, True)
    oled.text(os.uname()[4][9:24], 0, 40, True)
    oled.show()
    time.sleep(2)
